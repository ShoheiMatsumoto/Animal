...
#define GETWND (CWindow::GetThis()->GetHwnd())
...
public:
	...
	// ウィンドウ ハンドルを返す
	static CWindow* GetThis(){return m_pThis;};
	HWND GetHwnd() const {return (this) ? m_hWnd : NULL;}
	HINSTANCE GetHInstance() const{return (this) ? m_hInstance : NULL;}
